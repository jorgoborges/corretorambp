...
import 'cad_dados_clientes.dart';

void main() {
  runApp(const cad_dados_enderecos());
}

class cad_dados_enderecos extends StatelessWidget {
  const cad_dados_enderecos({Key? key}) : super(key: key);
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            ElevatedButton.icon(
              onPressed: () => Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                      builder: (_) => const cad_dados_enderecos())),
